...
_LEGACY_VECTOR_DIMENSIONS = get_settings().vector_dimensions
_EMBEDDINGS_VECTOR_DIMENSIONS = get_settings().embeddings_vector_dimensions
...
class KnowledgeChunk(Base):
    ...
    embedding: Mapped[list[float]] = mapped_column(Vector(_LEGACY_VECTOR_DIMENSIONS), nullable=False)
    embedding_v2: Mapped[list[float] | None] = mapped_column(Vector(_EMBEDDINGS_VECTOR_DIMENSIONS), nullable=True)
